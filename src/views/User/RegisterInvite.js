...
import { GET_INVITE_DETAILS } from '@/graphql/queries/invites'
import { BUYER_ROLES_QUERY } from './graphql/queries'
...
const RegisterInvite = () => {
  ...
  const inviteId = history.location.pathname.split('register/')[1]

  const {
    loading: loadingRoles,
    data: { buyerRoles = [] } = {}
  } = useQuery(BUYER_ROLES_QUERY)
